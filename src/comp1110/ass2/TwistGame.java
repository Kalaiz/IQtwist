...
return maincontainerva;
  ...
  /*
   *use the set getViablePiecePlacements(String placement)
   */

  public static boolean is_viablePlacement(String placement){
    Set<String> start = getViablePiecePlacements(placement);
    if(start.isEmpty()){
      return false;}
    else {
      return true;
  ...
  public static String[] getSolutions(String placement) {//Use task 6 code here
    ...
    if(is_viablePlacement(solution.toString())){
      Set<String> nextstep = getViablePiecePlacements(solution.toString());
