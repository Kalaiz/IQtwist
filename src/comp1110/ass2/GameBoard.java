...
public class GameBoard {
    ...
    void refreshBoardvalues(String s){ //TODO-Try to implement Map function using streams
   int row=10,col=12;
   if(s=="ac"){
       refreshBoardvalues("a");
       refreshBoardvalues("c");
   }
   else if (s.equals("a")){
     row=4;
     col=8;
    ...
    void pieceTobeAdded(String piece,String bt){
        ...
        if(bt=="a"){this.actualBoard=placer(actualBoard,p.getactual_piece(),row , col, 0);}
        else{
